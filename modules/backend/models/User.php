...
class User extends UserBase {
    ...
    /* Customed Relations | START */

    public $hasMany = [
        'Implementer' => [
            'Worcbox\Syaq\Models\OrderAttachment',
            'otherKey' => 'implementer_user_id',
        ],
        'ReviewerOrderAttachments' => [
            'Worcbox\Syaq\Models\OrderAttachment',
            'otherKey' => 'reviewer_user_id',
        ],
    ];

    public function scopeIsImplementer($query) {
